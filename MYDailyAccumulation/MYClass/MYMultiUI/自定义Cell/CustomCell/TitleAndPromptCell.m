...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        if (self.keyLabel == nil) {
            ...
            self.keyLabel.font = AdaptedFont(14);
        ...
        if (self.valueLabel==nil) {
            ...
            self.valueLabel.font = AdaptedFont(14);
        ...
        if (self.lineView==nil) {
            ...
            self.lineView.backgroundColor = BaseColor_Cell_SplitLine;
    ...
    switch (cellType) {
        case TitleAndPromptCellTypeInput: {
            ...
            [self.valueLabel mas_remakeConstraints:^(MASConstraintMaker *make) {
                ...
                make.size.mas_equalTo(CGSizeMake(kScreenW-80-2*spaceWith, 20));
            }];
