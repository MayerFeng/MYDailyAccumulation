...
+ (NSString *)timeIntervalDesWithSec:(NSUInteger)sec {
    ...
    if (sec < 60) {
        return [NSString stringWithFormat:@"%ld秒钟", sec];
    } else if (sec < 3600) {
        return [NSString stringWithFormat:@"%ld分钟", sec / 60];
    } else if (sec < 86400) {
        return [NSString stringWithFormat:@"%ld小时", sec / 3600];
    } else {
        return [NSString stringWithFormat:@"%ld天", sec / 86400];
    }
}
